...
public class DeleteCategory {
    ...
    public DeleteCategory(Category selectedCategory, Activity activity, FloatingActionButton fab,
                          ExpandableListView expandableListView,ListView listView) {
        ...
        listView = (ListView) activity.findViewById(R.id.uncategoryList);
        listPopulate= new ListPopulate(listView, expandableListView, activity);
